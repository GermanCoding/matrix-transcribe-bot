...
b.client.SetCredentials(id.UserID(s.UserID), id.DeviceID(s.DeviceID), s.AccessToken)
return nil
}
...
if evt.GetStateKey() == nil || *evt.GetStateKey() != b.client.UserID.String() {
return
}
...
if msg.MsgType != event.MsgAudio && msg.MsgType != event.MsgVideo {
return
}
...
data, err := b.client.DownloadBytes(context.Background(), mxc)
if err != nil {
return "", err
}
